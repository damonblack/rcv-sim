...
exports.deleteOldElections = functions.https.onRequest((req, res) => {
    ...
    const oldItemsQuery = elections.orderByChild('created').startAt(0).endAt(cutoff);
    const updates = {};
    ...
    return res.send("delete request was queued successfully, review database log for results");
  });
